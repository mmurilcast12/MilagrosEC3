...
public class JwUtil implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -722731184931769068L;
	
	public static final long JWT_TOKEN_VALIDITY = 1 * 30 * 60; // Duración - 1/2 hora
